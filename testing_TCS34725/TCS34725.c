...
// Public functions
// -----------------------------------------------------------------------------
bool TCS34725_Init(TCS34725_t *dev)
{
...
void TCS34725_Enable(TCS34725_t *dev)
{
...
void TCS34725_GetRawData(TCS34725_t *dev, uint16_t *r, uint16_t *g, uint16_t *b, uint16_t *c)
{
...
uint16_t TCS34725_CalculateColorTemp(uint16_t r, uint16_t g, uint16_t b)
{
